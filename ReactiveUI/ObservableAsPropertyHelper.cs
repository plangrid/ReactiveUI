            ...
            var ret = new ObservableAsPropertyHelper<TRet>(observable,
                _ => {
                    try {
                        ...
                        throw new Exception($"Error raising property changed for '{expression}' on target {This}", e);
                    }
                },
                _ => {
                    try {
                        ...
                        throw new Exception($"Error raising property changing for '{expression}' on target {This}", e);
                    }
                },
